...
export default function VerifyEmail() {
    const {verifyEmail, resendEmailConfirm} = useAccount();
            ...
            case 'failed':
                return (
                    <Box display='flex' flexDirection='column' gap={2} justifyContent='center'>
                        ...
                        <Button
                            onClick={() => resendEmailConfirm.mutate({userId})}
  ...
  return (
    ...
    >
        ...
        <Typography gutterBottom variant='h3' sx={{mb: 2}}>Email Verification</Typography>
        <Divider />
        {getBody()}
    </Paper>
  )
